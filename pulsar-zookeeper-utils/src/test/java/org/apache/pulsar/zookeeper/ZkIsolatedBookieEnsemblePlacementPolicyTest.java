...
public class ZkIsolatedBookieEnsemblePlacementPolicyTest {
    ...
    public void testBasic() throws Exception {
        ...
        isolationPolicy.initialize(bkClientConf, Optional.empty(), timer, SettableFeatureProvider.DISABLE_ALL, NullStatsLogger.INSTANCE, new DefaultBookieAddressResolver(new MockRegistrationClient()));
    ...
    public void testNoIsolationGroup() throws Exception {
        ...
        isolationPolicy.initialize(bkClientConf, Optional.empty(), timer, SettableFeatureProvider.DISABLE_ALL,
                NullStatsLogger.INSTANCE, new DefaultBookieAddressResolver(new MockRegistrationClient()));
        isolationPolicy.onClusterChanged(writableBookies, readOnlyBookies);
